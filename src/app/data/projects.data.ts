...
export const PROJECTS: Project[] = [
    ...
    details: {
      ...
      sections: [
        ...
        },
        {
          ...
          caption:
            'Figure 3 shows the connection between the Raspberry Pi and Arduino, while Figure 4 presents the real-world wiring setup with the connected components. The touch-screen interface is directly connected to the Raspberry Pi.',
        },
        {
          heading: 'Components',
          content:
...

  {
    ...
    subtitle: 'Bachelor’s Thesis in Information Technology',
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            ...
            'Figure 23 demonstrates the completion of a sample quest for an NPC. The example shows how the system recognizes that all objectives have been fulfilled and updates the quest status accordingly. After completion the player receives a reward.',
          images: [
    ...
    details: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            'At one stage, I created my own original characters (OCs) and painted several illustrations featuring this characters, as well as a short comic. This helped me practice character design, visual storytelling and consistency across multiple artworks.',
          images: [
